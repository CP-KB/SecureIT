...
LINKER=i386 g++
CPP= main.cpp ModuleAction.cpp ModuleScan.cpp Forms/MainWindow.cpp Forms/FrmScriptEditor.cpp Tests.cpp
OBJS = main.o ModuleAction.o ModuleScan.o MainWindow.o FrmScriptEditor.o Tests.o
